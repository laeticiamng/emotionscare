...
export interface Challenge {
  ...
  icon?: string; // Pour l'icône du défi
  unlockCriteria?: string; // Pour critères de déblocage
}
...
export interface GamificationStats {
  ...
  streak: number;
  progressToNextLevel?: number; // Pourcentage de progrès vers le niveau suivant
