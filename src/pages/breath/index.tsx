      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto" data-zero-number-check="true">
        ...
        >
          ...
          <DialogFooter className="flex items-center justify-end gap-3">
            ...
            <Button type="submit" disabled={!items.length || assessment.state.isSubmitting}>
  ...
  return (
    <ZeroNumberBoundary className="min-h-screen bg-slate-950 py-10 text-slate-100">
      ...
      <AssessmentDialog
        ...
        kind="STAI6"
        label="Check-in STAI-6"
        description="Quelques ressentis pour calibrer le souffle avant ou après ta session."
        onClose={() => undefined}
      />
      <AssessmentDialog
        assessment={isiAssessment}
        kind="ISI"
        label="Ressenti sommeil"
        description="Sept ressentis pour ajuster la routine du soir."
        onClose={() => undefined}
      />
    </ZeroNumberBoundary>
  );
