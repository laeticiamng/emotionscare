...
function fixImportsInFile(filePath) {
  if (!fs.existsSync(filePath) || filePath.includes('.d.ts')) return false;
  ...
  try {
    ...
    // Replace all lucide-react imports with @/lib/icons
...
// Execute the fix
console.log('🔄 Fixing all remaining lucide-react imports...');
