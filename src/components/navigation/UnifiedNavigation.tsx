...
import { 
  ...
  Users, Calendar, Settings, Glasses, HeartHandshake, Trophy, Building, BarChart2
} from 'lucide-react';
...
const UnifiedNavigation: React.FC<UnifiedNavigationProps> = ({ collapsed = false, onItemClick }) => {
  ...
  // Définir les éléments de navigation selon le mode utilisateur
  let navItems = [
    { title: "Accueil", href: "/", icon: Home }
  ];
  
  // B2C navigation items
  if (userMode === 'b2c' || !userMode) {
    navItems = [
