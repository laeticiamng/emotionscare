...
const FAQS: FAQCategory[] = [
  {
    ...
    questions: [
      ...
      { q: 'Dans quelles langues l\'application est-elle disponible ?', a: 'EmotionsCare est actuellement disponible en français. D\'autres langues seront ajoutées prochainement.' },
