...
const MODULES: PlatformModule[] = [
  ...
  { id: 12, title: 'Niveaux et badges', category: 'Gamification', status: 'partial', route: '/app/achievements', description: 'Débloquez des badges et montez en niveaux au fil de votre parcours dans le Parc Émotionnel. Partagez vos succès et exportez votre progression.', nextStep: 'Unifier règles de déblocage et lisibilité progression.' },
  ...
  { id: 18, title: 'Programme de prévention', category: 'B2B / RH', status: 'missing', route: '/contact', description: 'Parcours de prévention sur mesure pour les établissements. Objectifs d\'équipe, suivi de l\'adoption et indicateurs d\'impact collectif. Module en cours de construction.', nextStep: 'Créer builder parcours + objectifs + suivi adoption.' },
  ...
  { id: 31, title: 'Visioconférence', category: 'Fonctionnalités avancées', status: 'missing', route: '/contact', description: 'Sessions de soutien en visioconférence avec consentement renforcé. Module de téléconsultation bien-être prévu pour les parcours accompagnés.', nextStep: 'Intégrer WebRTC + consentement renforcé.' },
  ...
  { id: 37, title: 'Conformité HDS opérationnelle', category: 'Fonctionnalités avancées', status: 'missing', route: '/contact', description: 'Hébergement de Données de Santé conforme à la réglementation française. Certification HDS, procédures d\'audit, chiffrement et traçabilité des accès.', nextStep: 'Plan HDS (hébergement, procédures, preuves, audits).' },
];
