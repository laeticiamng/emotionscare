-- Nettoyage et création du système de gamification complet
...
CREATE POLICY "challenges_service_role" ON challenges
...
CREATE POLICY "points_history_service_role" ON points_history
  FOR ALL USING ((auth.jwt() ->> 'role') = 'service_role');
...
('Champion Mensuel', 'Maintenez une série de 30 jours', 'streak', 'epic', '🏆',
 '[{"type": "streak", "target": 30, "description": "Série de 30 jours consédutifs"}]',
