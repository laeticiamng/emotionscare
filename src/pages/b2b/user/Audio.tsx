...
import { PlayCircle, SkipForward, SkipBack, Volume2 } from 'lucide-react';

const B2BUserAudio: React.FC = () => {
  return (
    <div className="container mx-auto py-6 space-y-8">
      ...
      <Tabs defaultValue="recommended">
        ...
        <TabsContent value="work" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Audio pour environnement professionnel</CardTitle>
              <CardDescription>Contenus audio adaptés pour le milieu de travail</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <div className="font-medium">Méditation de bureau - 5 min</div>
                    <div className="text-sm text-muted-foreground">Parfait pour une pause rapide</div>
                  </div>
                  <Button size="sm" variant="outline">Écouter</Button>
                </div>
                <div className="border rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <div className="font-medium">Respiration anti-stress - 3 min</div>
                    <div className="text-sm text-muted-foreground">Idéal avant une réunion importante</div>
                  </div>
                  <Button size="sm" variant="outline">Écouter</Button>
                </div>
                <div className="border rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <div className="font-medium">Ambiance sonore Focus - 60 min</div>
                    <div className="text-sm text-muted-foreground">Pour les sessions de travail intenses</div>
                  </div>
                  <Button size="sm" variant="outline">Écouter</Button>
                </div>
                <div className="border rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <div className="font-medium">Déconnexion fin de journée - 10 min</div>
                    <div className="text-sm text-muted-foreground">Transition entre travail et maison</div>
                  </div>
                  <Button size="sm" variant="outline">Écouter</Button>
                </div>
              </div>
