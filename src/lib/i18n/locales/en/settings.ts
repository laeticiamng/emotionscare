export const settings = {
  ...
  shareData: 'Data Sharing',
  anonymousData: 'Anonymous Data',
  
  // Privacy toggles
  allowEmotionScan: 'Allow Emotion Scanning',
  allowVoiceRecording: 'Allow Voice Recording',
  allowCameraAccess: 'Allow Camera Access',
  allowHeartRateMonitoring: 'Allow Heart Rate Monitoring',
  allowNotifications: 'Allow Notifications',
  allowDataProcessing: 'Allow Data Processing',
  ...
  breathworkReminders: 'Breathwork Reminders',
