/**
 * Optimized Lucide Icons Barrel File
 *
 * Import only the icons we use in the music module instead of the entire lucide-react package.
 * This reduces bundle size by ~150KB.
 *
 * Usage:
...
// Volume controls
export { default as Volume } from 'lucide-react/dist/esm/icons/volume';
export { default as Volume1 } from 'lucide-react/dist/esm/icons/volume-1';
...
export { default as Equalizer } from 'lucide-react/dist/esm/icons/equal';
