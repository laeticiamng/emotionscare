...
const MODULES: PlatformModule[] = [
  ...
  { id: 18, title: 'Programme de prévention', category: 'B2B / RH', status: 'done', route: '/b2b/prevention', description: 'Parcours de prévention sur mesure pour les établissements. Objectifs d\'équipe, suivi de l\'adoption et indicateurs d\'impact collectif.' },
  ...
  { id: 31, title: 'Visioconférence', category: 'Fonctionnalités avancées', status: 'done', route: '/app/visio', description: 'Sessions de soutien en visioconférence avec consentement renforcé. Cercles de parole, ateliers et accompagnement individuel.' },
  ...
  { id: 37, title: 'Conformité HDS opérationnelle', category: 'Fonctionnalités avancées', status: 'done', route: '/compliance/hds', description: 'Hébergement de Données de Santé conforme à la réglementation française. Certification HDS, procédures d\'audit, chiffrement et traçabilité des accès.' },
];
