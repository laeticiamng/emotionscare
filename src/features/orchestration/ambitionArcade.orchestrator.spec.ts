...
import { AMBITION_MICRO_LEVERS, ambitionArcadeOrchestrator } from './ambitionArcade.orchestrator';
...
describe('ambitionArcadeOrchestrator', () => {
  it('returns gently progressing label for low GAS level', () => {
    ...
    expect(microLeverAction).toMatchObject({ items: AMBITION_MICRO_LEVERS });
  });
