...
import { BookOpen, Calendar, ListFilter, Plus } from 'lucide-react';
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">
            Suivez et analysez vos émotions au quotidien pour une meilleure compréhension de votre bien-être.
          </p>
        </div>
