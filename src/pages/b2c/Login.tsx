  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Utilisez user@exemple.fr / password pour tester",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        >
          <Card className="shadow-lg border-blue-200 dark:border-blue-800/30">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-blue-800 dark:text-blue-300">Espace Particulier</CardTitle>
              <CardDescription className="text-blue-600/70 dark:text-blue-400/70">Connectez-vous à votre espace personnel</CardDescription>
            </CardHeader>
            <form onSubmit={handleLogin}>
              ...
              <CardFooter className="flex flex-col gap-4">
                ...
                >
                  <span className="text-blue-500/70 dark:text-blue-400/70">Pas encore de compte? </span>
                  <Link to="/b2c/register" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
                    S'inscrire
                  </Link>
                </motion.div>
                <motion.div 
