            ...
            <div className="container px-4 sm:px-6 lg:px-8">
              <div className="max-w-5xl mx-auto">
                <Reveal>
                  ...
                  <p className="text-xl text-muted-foreground text-center max-w-2xl mx-auto mb-16 font-light">
                    Des outils concrets pour accompagner votre bien-être au quotidien.
                  </p>
                </Reveal>
                  ...
                  {[
                    {
                      ...
                      description:
                        'Évaluez votre état émotionnel en quelques questions et recevez des recommandations personnalisées.',
                    },
                    {
                      icon: Heart,
                      title: 'Protocoles de respiration',
                      description:
                        'Cohérence cardiaque, technique 4-7-8, box breathing : des exercices guidés de 3 minutes pour retrouver le calme.',
                    },
                    {
                      icon: Sparkles,
                      title: 'Coach IA',
                    ...
                    },
                    {
                      ...
                      description:
                        'Un sas d\'apaisement avant le sommeil : respiration immersive et ambiance sonore pour un endormissement serein.',
                    },
                    {
                      icon: Target,
                      title: 'Journal émotionnel',
                      description:
                        'Consignez vos pensées et émotions dans un journal chiffré. Écriture libre ou dictée vocale.',
                    },
                    {
                      icon: Shield,
                      title: 'Suivi et progression',
                      description:
                        'Visualisez l\'évolution de votre bien-être sur 7, 30 ou 90 jours avec des indicateurs clairs.',
                    },
                  ].map((module, i) => (
                    <Reveal key={i} delay={i * 0.1}>
                      <div className="group rounded-3xl border border-border/50 p-8 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 h-full flex flex-col">
                        <module.icon className="h-8 w-8 text-primary mb-4 flex-shrink-0" />
