/**
 * Page 404 avec notre nouvelle infrastructure intégrée
 * Utilise validation, observabilité, accessibilité et i18n
 */
  ...
  return (
    <AccessibilityProvider>
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted flex items-center justify-center p-4">
        ...
        <div className="max-w-2xl w-full" data-testid="page-root">
