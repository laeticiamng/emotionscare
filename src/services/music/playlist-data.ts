...
export const emotionPlaylists: Record<string, MusicTrack[]> = {
  calm: [
    ...
    },
    {
      ...
      duration: 240,
      audioUrl: 'https://cdn.pixabay.com/audio/2021/11/25/audio_00fa5593f3.mp3',
    ...
    },
    {
      ...
      duration: 210,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/03/15/audio_90852d2423.mp3',
  ...
  happy: [
    ...
    },
    {
      ...
      artist: 'Mood Lifters',
      duration: 195,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/10/30/audio_946f4ebb05.mp3',
    ...
    },
    {
      ...
      duration: 182,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/08/04/audio_884fe92c21.mp3',
  ...
  energetic: [
    {
      ...
      duration: 175,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/03/10/audio_40ce8a1485.mp3',
    ...
    },
    {
      ...
      duration: 188,
      audioUrl: 'https://cdn.pixabay.com/audio/2021/12/13/audio_cb4f1211a4.mp3',
  ...
  focused: [
    {
      ...
      artist: 'Mind Focus',
      duration: 210,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/04/27/audio_c8182d3dfd.mp3',
  ...
  neutral: [
    {
      ...
      duration: 190,
      audioUrl: 'https://cdn.pixabay.com/audio/2022/02/22/audio_508bd7ce5e.mp3',
    ...
    },
    {
      ...
      duration: 205,
      audioUrl: 'https://cdn.pixabay.com/audio/2021/09/06/audio_9614bc2d96.mp3',
