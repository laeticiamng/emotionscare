...
const MODULES: PlatformModule[] = [
  ...
  { id: 2, title: 'Coach IA', category: 'Bien-être émotionnel', status: 'partial', route: '/app/coach', description: 'Votre coach émotionnel IA disponible 24/7. Conversations bienveillantes, conseils personnalisés pour la gestion du stress et le développement personnel, adaptés aux professionnels de santé.', nextStep: 'Renforcer prompts soignants + garde-fous cliniques + fallback crise.' },
  ...
  { id: 7, title: 'Protocole Respirez', category: 'Bien-être émotionnel', status: 'partial', route: '/dashboard/breathing', description: 'Exercices de respiration guidée basés sur les neurosciences : cohérence cardiaque, technique 4-7-8, box breathing et plus. Choisissez votre protocole et suivez vos progrès.', nextStep: 'Ajouter protocoles supplémentaires et recommandations selon le scan.' },
  ...
  { id: 18, title: 'Programme de prévention', category: 'B2B / RH', status: 'complete', route: '/b2b/prevention', description: 'Parcours de prévention sur mesure pour les établissements. Objectifs d\'équipe, suivi de l\'adoption et indicateurs d\'impact collectif.', nextStep: '' },
  ...
  { id: 31, title: 'Visioconférence', category: 'Fonctionnalités avancées', status: 'complete', route: '/app/visio', description: 'Sessions de soutien en visioconférence avec consentement renforcé. Cercles de parole, ateliers et accompagnement individuel.', nextStep: '' },
  ...
  { id: 37, title: 'Conformité données de santé', category: 'Fonctionnalités avancées', status: 'partial', route: '/compliance/securite-sante', description: 'Hébergement sécurisé conforme RGPD avec chiffrement, traçabilité des accès et procédures d\'audit.', nextStep: 'Finaliser la documentation de conformité.' },
];
