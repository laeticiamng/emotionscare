// @ts-nocheck
/**
 * generate-incident-report - Génération de rapports d'incident avec analyse ML
 *
...
serve(async (req) => {
  ...
  const rateLimit = await enforceEdgeRateLimit(req, {
    route: 'generate-incident-report',
    userId: user.id,
    limit: 5,
    windowMs: 60_000,
    description: 'Incident report generation - Admin only',
  });
