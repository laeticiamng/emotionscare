...
// URLs de fallback - Pixabay audio (CORS natif, format: /audio/ pas /download/)
const FALLBACK_TRACKS: Record<string, { url: string; duration: number; bpm: number }[]> = {
  ...
  energize: [
    ...
    { url: 'https://cdn.pixabay.com/audio/2022/08/02/audio_884fe92c21.mp3', duration: 165, bpm: 110 },
  ],
  focus: [
    { url: 'https://cdn.pixabay.com/audio/2022/03/15/audio_8cb749d484.mp3', duration: 240, bpm: 80 },
    { url: 'https://cdn.pixabay.com/audio/2022/01/18/audio_d0c6ff1bab.mp3', duration: 200, bpm: 75 },
  ],
  sleep: [
    { url: 'https://cdn.pixabay.com/audio/2021/04/06/audio_63aa86e805.mp3', duration: 300, bpm: 50 },
    { url: 'https://cdn.pixabay.com/audio/2022/05/27/audio_1808fbf07a.mp3', duration: 280, bpm: 45 },
  ],
  meditation: [
    { url: 'https://cdn.pixabay.com/audio/2022/05/27/audio_1808fbf07a.mp3', duration: 120, bpm: 60 },
    { url: 'https://cdn.pixabay.com/audio/2021/04/06/audio_63aa86e805.mp3', duration: 180, bpm: 55 },
  ],
  anxiety: [
    { url: 'https://cdn.pixabay.com/audio/2022/05/27/audio_1808fbf07a.mp3', duration: 200, bpm: 65 },
  ],
  joy: [
