...
export const auth = {
  ...
  loginSubtitle: 'Zugang zu Ihrem persönlichen EmotionsCare-Bereich',
  ...
  signupSubtitle: 'Treten Sie der EmotionsCare-Community bei',
  firstName: 'Vorname',
  lastName: 'Nachname',
  ...
  resetPasswordSubtitle: 'Geben Sie Ihre E-Mail ein, um einen Link zum Zurücksetzen zu erhalten',
  sendResetLink: 'Link zum Zurücksetzen senden',
  checkEmail: 'Überprüfen Sie Ihre E-Mail',
  resetLinkSent: 'Ein Link zum Zurücksetzen wurde an Ihre E-Mail-Adresse gesendet',
