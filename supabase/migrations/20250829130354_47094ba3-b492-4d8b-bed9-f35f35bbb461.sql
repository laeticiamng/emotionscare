-- EmotionsCare Minimal Schema (corrected)
-- Tables for metrics, journal, goals, music sessions, push subscriptions, org aggregates, exports

-- Profiles table for user preferences and roles (simplified)
...
-- Org aggregates policies (simplified)
CREATE POLICY "Users can view org aggregates" ON public.org_aggregates
