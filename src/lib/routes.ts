...
export const b2cRoutes = {
  ...
  emotionSessions: () => resolveRoutePath('emotion-sessions'),
  emotionSessionsNew: () => resolveRoutePath('emotion-sessions-new'),
  breath: () => resolveRoutePath('breath'),
  vr: () => resolveRoutePath('vr'),
  vrGalaxy: () => resolveRoutePath('vr-galaxy'),
  vrBreath: () => resolveRoutePath('vr-breath-guide'),
  ...
  community: () => resolveRoutePath('community-legacy'),
