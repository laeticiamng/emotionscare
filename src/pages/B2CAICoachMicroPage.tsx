        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-warning to-warning-foreground bg-clip-text text-transparent">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-card/20 backdrop-blur-sm rounded-2xl p-6 border border-border/10 mb-6">
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  className="w-full h-24 bg-background/10 border border-border/20 rounded-lg px-4 py-3 text-foreground placeholder-muted-foreground resize-none focus:outline-none focus:ring-2 focus:ring-warning/50"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-warning to-warning-foreground text-foreground font-medium py-3 px-6 rounded-lg hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isProcessing ? (
                    <>
            ...
            <div className="space-y-4">
              {responses.map((response) => (
                <div key={response.id} className="bg-card/20 backdrop-blur-sm rounded-xl p-6 border border-border/10">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-gradient-to-br from-warning to-warning-foreground rounded-full flex items-center justify-center flex-shrink-0">
