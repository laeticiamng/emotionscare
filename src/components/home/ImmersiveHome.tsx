    ...
    <div className="min-h-screen relative overflow-hidden immersive-bg">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        ...
        >
          ...
          <motion.h1 
            className="immersive-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 px-2"
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
          ...
          {/* Sous-titre */}
          <motion.p 
            className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
