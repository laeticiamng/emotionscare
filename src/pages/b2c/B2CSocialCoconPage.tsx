...
const B2CSocialCoconPage: React.FC = () => {
  ...
  return (
    <div data-testid="page-root" className="min-h-screen bg-gradient-to-br from-muted via-rose-50 to-muted/80">
              ...
              <CardContent className="space-y-6">
                {quickSuggestions.length > 0 && (
                  <div className="space-y-3">
                    <p className="text-sm font-medium text-muted-foreground">Suggestions rapides</p>
                ...
                <form className="space-y-5" onSubmit={handleScheduleSubmit}>
                  <div className="space-y-2">
                    ...
                    <select
                      id="room-select"
                      className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-300 focus-visible:ring-2 focus-visible:ring-rose-400"
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3">
                    {upcomingBreaks.map((plan) => {
                      ...
                      return (
                        <li key={plan.id} className="rounded-xl border border-border bg-card px-4 py-3">
                      ...
                      <CardHeader className="space-y-2">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                          ...
                          <span className="inline-flex items-center gap-1">
                            ...
                            Lien interne : <code className="rounded bg-muted px-1 py-0.5">{room.inviteCode}</code>
                          </span>
                        </div>
                      </CardHeader>
