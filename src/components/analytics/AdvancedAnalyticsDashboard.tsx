...
export const AdvancedAnalyticsDashboard: React.FC = () => {
  ...
  const pointsChartData = {
    ...
    datasets: [
      {
        label: 'Vos points',
        data: [...analyticsData.userPoints, ...analyticsData.predictions.map((_, i) => i === 0 ? analyticsData.userPoints[analyticsData.userPoints.length - 1] : null)].filter((_v, i) => i < analyticsData.userPoints.length || analyticsData.predictions[i - analyticsData.userPoints.length] !== undefined),
