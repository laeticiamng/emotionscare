...
const MODULES: PlatformModule[] = [
  ...
  { id: 7, title: 'Protocole Respirez', category: 'Bien-être émotionnel', status: 'partial', route: '/dashboard/breathing', description: '{ id: 7, title: 'Protocole Respirez', category: 'Bien-être émotionnel', status: 'partial', route: '/dashboard/breathing', description: 'Exercices de respiration guidée basés sur les neurosciences : cohérence cardiaque, technique 4-7-8, box breathing et plus. Choisissez votre protocole et suivez vos progrès.', nextStep: 'Ajouter protocoles supplémentaires et recommandations selon le scan.' },, technique 4-7-8, box breathing et plus. Choisissez votre protocole et suivez vos progrès.', nextStep: 'Ajouter protocoles supplémentaires et recommandations selon le scan.' },
