      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Félicitations pour avoir complété votre Flow Walk
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                ...
                <li>• Meilleure connexion corps-esprit</li>
                <li>• Renforcement de la pleine conscience</li>
              </ul>
            </div>

            <div className="space-y-3">
              <Button
                onClick={() => navigate('/breath/flowwalk')}
                className="w-full"
              >
                Refaire une session
              </Button>
