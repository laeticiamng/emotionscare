...
export const mockPlaylists: MusicPlaylist[] = [
  {
    ...
    emotion: 'calm',
    mood: 'calm',
    tracks: musicTracks.filter(track => track.emotion === 'calm' || track.mood === 'calm'),
  ...
  },
  {
    ...
    emotion: 'focused',
    mood: 'focused',
    tracks: musicTracks.filter(track => track.emotion === 'focused' || track.mood === 'focused'),
  ...
  },
  {
    ...
    emotion: 'happy',
    mood: 'happy',
    tracks: musicTracks.filter(track => track.emotion === 'happy' || track.mood === 'happy'),
