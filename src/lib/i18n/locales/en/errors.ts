export const errors = {
  ...
  webrtcNotSupported: 'WebRTC not supported',
  ...
  webxrNotAvailable: 'WebXR not available',
  ...
  emotionScanError: 'Emotion scan error',
  musicGenerationError: 'Music generation error',
  aiCoachError: 'AI coach error',
  journalError: 'Journal error',
  vrInitError: 'VR initialization error',
