...
import { ArrowLeft, User, Shield, Mail, Lock, CheckCircle, AlertCircle } from 'lucide-react';
...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && !isLoading) {
      ...
      toast({
        ...
        description: `Bienvenue ${user?.name || 'sur EmotionsCare'}! 👋`,
      });
      
      // Slight delay for better UX
      setTimeout(() => navigate(from), 300);
    }
  }, [isAuthenticated, isLoading, navigate, location, toast, user]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Toast is shown in the useEffect above after authentication state changes
    } catch (error: any) {
    ...
    >
      ...
      <div className="container max-w-md z-10">
        <div className="mb-8">
          <Button
            variant="ghost"
            className="mb-4 group hover:bg-white/80"
            onClick={() => navigate('/')}
          >
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                {showMagicLink && (
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="magic-link" className="cursor-pointer">Utiliser un lien magique</Label>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="remember-me" className="cursor-pointer">Se souvenir de moi</Label>
                  </div>
              ...
              <CardFooter className="flex flex-col space-y-3">
                ...
                >
                  <Button 
                    type="submit" 
                    className="w-full bg-[#3B82F6] hover:bg-[#2563EB] text-white relative overflow-hidden group"
        ...
        >
          <Button 
            size="icon" 
            className="h-12 w-12 rounded-full shadow-lg bg-primary text-white hover:bg-primary/90 hover:scale-110 transition-all"
            onClick={() => toast({
              title: "Assistance disponible",
              description: "Un conseiller va vous répondre dans quelques instants.",
            })}
          >
