...
export default function CommunityPage() {
  ...
  const { groups, myGroups, loading: groupsLoading, joinGroup, leaveGroup, createGroup, refresh: _refreshGroups } = useCommunityGroups();
  const { posts, loading: postsLoading, createPost, toggleReaction, refresh: _refreshPosts } = useCommunityPosts();
